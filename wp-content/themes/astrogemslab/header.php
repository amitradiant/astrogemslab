                  ...
                  <img class="img-fluid" src="<?php echo esc_url($logo_image['url']); ?>" alt="<?php echo esc_attr($logo_image['alt']); ?>">
                    ...
                    <div class="col-md-3">
                        <div class="shop-account-option">
                            ...
                            <a class="shop-account-option-item account-option" href="<?php echo esc_url( get_page_link( 14 ) ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/user-icon.png" alt=""></a>
